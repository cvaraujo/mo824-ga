 ...
 */
public class GA_QBFTP_LH extends AbstractGA<Integer, Integer> {
	 ...
	 */
	public GA_QBFTP_LH(Integer generations, Integer popSize, Double mutationRate, String filename) throws IOException {
	...
	protected Population initializePopulation() {
		...
		for (int i = 0; i < chromosomeSize; i++) {
			...
			for (int j = 0; j < M; j++) {
				population.get(j).add(array.get(j) % 2);
			}
		}
	...
	public static void main(String[] args) throws IOException {
		...
		GA_QBFTP_LH ga = new GA_QBFTP_LH(1000, 1000, 1.0 / 100.0, "../instances/qbf" + args[0]);
