 ...
 */
public class GA_QBFTP extends AbstractGA<Integer, Integer> {
	 ...
	 */
	public GA_QBFTP(Integer generations, Integer popSize, Double mutationRate, String filename) throws IOException {
